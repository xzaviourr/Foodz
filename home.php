...
<nav class="navbar " style="background-color: white;">
  ...
  <ul class="nav nav-pills">
    ...
    <li class="nav-item">
      <a class="nav-link" href="viewcart.php" style="color: #D70F64;font-weight: bold;font-size:1vw;"><i class="fas fa-cart-plus" style="color:#D70F64; font-size:1vw;"></i>   CART</a>
    </li>
    <?php
